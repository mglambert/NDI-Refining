...
imgs = {};
imgs{1} = log(abs(fftshift(fftn(QSMnetp_recon(1:164, 1:205, 1:205) .* mask)))+1);
imgs{2} = log(abs(fftshift(fftn(xQSM_recon(1:164, 1:205, 1:205) .* mask)))+1);
imgs{3} = log(abs(fftshift(fftn(ours(1:164, 1:205, 1:205) .* mask)))+1);
imgs{4} = log(abs(fftshift(fftn(fansi_recon(1:164, 1:205, 1:205) .* mask)))+1);

imagen_papers2(imgs, [1,1,1], [90,90,90], [0, 10], 'vertical', 0);

%%
imgs = {};
imgs{1} = log(abs(fftshift(fftn(outndi_qsmnet.x(1:164, 1:205, 1:205) .* mask)))+1);
imgs{2} = log(abs(fftshift(fftn(outndi_xqsm.x(1:164, 1:205, 1:205) .* mask)))+1);
imgs{3} = log(abs(fftshift(fftn(outndi_cpnet.x(1:164, 1:205, 1:205) .* mask)))+1);
imgs{4} = log(abs(fftshift(fftn(outndi_fansi.x(1:164, 1:205, 1:205) .* mask)))+1);
...
% imgs = {};
% imgs{1} = log(abs(fftshift(fftn(outndi_qsmnet.x(1:164, 1:205, 1:205) .* mask)))+1) - log(abs(fftshift(fftn(QSMnetp_recon(1:164, 1:205, 1:205) .* mask)))+1);
% imgs{2} = log(abs(fftshift(fftn(outndi_xqsm.x(1:164, 1:205, 1:205) .* mask)))+1) - log(abs(fftshift(fftn(xQSM_recon(1:164, 1:205, 1:205) .* mask)))+1);
% imgs{3} = log(abs(fftshift(fftn(outndi_cpnet.x(1:164, 1:205, 1:205) .* mask)))+1) - log(abs(fftshift(fftn(ours(1:164, 1:205, 1:205) .* mask)))+1);
% imgs{4} = log(abs(fftshift(fftn(outndi_fansi.x(1:164, 1:205, 1:205) .* mask)))+1) - log(abs(fftshift(fftn(fansi_recon(1:164, 1:205, 1:205) .* mask)))+1);
% 
% imagen_papers2(imgs, [1,1,1], [90,90,90], [-1, 1], 'vertical', 0);
% v = -1:0.02:1;
% R=v+1;
% R(R>1)=1;
% B=-v+1;
...
imgs{1} = log(abs(fftshift(fftn(outndi_qsmnet.x(1:164, 1:205, 1:205) .* mask))) ./ abs(fftshift(fftn(QSMnetp_recon(1:164, 1:205, 1:205) .* mask))));
imgs{2} = log(abs(fftshift(fftn(outndi_xqsm.x(1:164, 1:205, 1:205) .* mask))) ./ abs(fftshift(fftn(xQSM_recon(1:164, 1:205, 1:205) .* mask))));
imgs{3} = log(abs(fftshift(fftn(outndi_cpnet.x(1:164, 1:205, 1:205) .* mask))) ./ abs(fftshift(fftn(ours(1:164, 1:205, 1:205) .* mask))));
imgs{4} = log(abs(fftshift(fftn(outndi_fansi.x(1:164, 1:205, 1:205) .* mask))) ./ abs(fftshift(fftn(fansi_recon(1:164, 1:205, 1:205) .* mask))));

imagen_papers2(imgs, [1,1,1], [90,90,90], [-1.5, 1.5], 'vertical', 0);
v = -1:0.02:1;
R=v+1;
R(R>1)=1;
B=-v+1;
