function out = nlTV(params,varargin)
...
[phase, alpha, N, Kernel, mu, mu2, maxOuterIter, ...
 tolUpdate, regweight, tolDelta, W, isGPU,isPrecond] = parse_inputs(params, varargin{:});
...
function [phase, alpha, N, Kernel, mu, mu2, maxOuterIter, tolUpdate, regweight, tolDelta, W, isGPU, isPrecond] = parse_inputs(params, varargin)
global DEBUG; if isempty(DEBUG); DEBUG = false; end
